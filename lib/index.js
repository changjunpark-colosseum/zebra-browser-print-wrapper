...
var ZebraBrowserPrintWrapper = /** @class */ (function () {
    function ZebraBrowserPrintWrapper() {
        ...
        this.checkConnection = function () { return __awaiter(_this, void 0, void 0, function () {
            var endpoint, controller_1, timeoutId, config, res, error_1, isHttps, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        console.log(error_1);
                        console.log('-----------');
                        console.log('error.name', error_1.name);
                        console.log('error.message', error_1.message);
                        console.log('error.stack', error_1.stack);
                        console.log('error.cause', error_1.cause);
                        console.log('error.prototype', error_1.prototype);
                        console.log('error.toString()', error_1.toString());
                        console.log('error.toJSON()', error_1.toJSON());
                        console.log('error.valueOf()', error_1.valueOf());
                        console.log('error.constructor', error_1.constructor);
        ...
        this.getAvailablePrinters = function () { return __awaiter(_this, void 0, void 0, function () {
            var healthCheck, config, endpoint, res, data, parseError_1, error_2, isHttps, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 9:
                        ...
                        if (error_2.name === 'TypeError' && error_2.message.includes('Failed to fetch')) {
                            isHttps = typeof window !== 'undefined' && window.location.protocol === 'https:';
                            if (isHttps) {
                                throw new types_1.ZebraError('Chrome 로컬 네트워크 접근 권한이 필요합니다. 브라우저 캐시를 삭제하거나 권한을 다시 허용해주세요.', types_1.ZebraErrorCode.PNA_PERMISSION_DENIED, error_2);
                            }
                            else {
                                throw new types_1.ZebraError('BrowserPrint 서비스에 연결할 수 없습니다. Zebra BrowserPrint가 설치되어 있고 실행 중인지 확인해주세요.', types_1.ZebraErrorCode.BROWSERPRINT_NOT_RUNNING, error_2);
                            }
                        }
        ...
        this.getDefaultPrinter = function () { return __awaiter(_this, void 0, void 0, function () {
            var healthCheck, config, endpoint, res, data, deviceRaw, name_1, deviceType, connection, uid, provider, manufacturer, error_3, isHttps, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.shouldCheckHealth()) return [3 /*break*/, 2];
                    ...
                    case 6:
                        ...
                        if (error_3.name === 'TypeError' && error_3.message.includes('Failed to fetch')) {
                            isHttps = typeof window !== 'undefined' && window.location.protocol === 'https:';
                            if (isHttps) {
                                throw new types_1.ZebraError('Chrome 로컬 네트워크 접근 권한이 필요합니다. 브라우저 캐시를 삭제하거나 권한을 다시 허용해주세요.', types_1.ZebraErrorCode.PNA_PERMISSION_DENIED, error_3);
                            }
                            else {
                                throw new types_1.ZebraError('BrowserPrint 서비스에 연결할 수 없습니다. Zebra BrowserPrint가 설치되어 있고 실행 중인지 확인해주세요.', types_1.ZebraErrorCode.BROWSERPRINT_NOT_RUNNING, error_3);
                            }
                        }
        ...
        this.write = function (data, retryWithFreshDevice) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var endpoint, myData, config, res, availablePrinters, freshDevice, i, refreshError_1, error_5, isHttps, errorMessage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 6, , 7]);
                        ...
                        case 6:
                            ...
                            if (error_5.name === 'TypeError' && error_5.message.includes('Failed to fetch')) {
                                ...
                                isHttps = typeof window !== 'undefined' && window.location.protocol === 'https:';
                                if (isHttps) {
                                    throw new types_1.ZebraError('Chrome 로컬 네트워크 접근 권한이 필요합니다. 브라우저 캐시를 삭제하거나 권한을 다시 허용해주세요.', types_1.ZebraErrorCode.PNA_PERMISSION_DENIED, error_5);
                                }
                                else {
                                    throw new types_1.ZebraError('BrowserPrint 서비스에 연결할 수 없습니다. Zebra BrowserPrint가 설치되어 있고 실행 중인지 확인해주세요.', types_1.ZebraErrorCode.BROWSERPRINT_NOT_RUNNING, error_5);
                                }
                            }
        ...
        this.read = function (retryWithFreshDevice) {
            if (retryWithFreshDevice === void 0) { retryWithFreshDevice = true; }
            return __awaiter(_this, void 0, void 0, function () {
                var endpoint, myData, config, res, availablePrinters, freshDevice, i, refreshError_2, data, error_6, isHttps, errorMessage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 7, , 8]);
                        ...
                        case 7:
                            ...
                            if (error_6.name === 'TypeError' && error_6.message.includes('Failed to fetch')) {
                                ...
                                isHttps = typeof window !== 'undefined' && window.location.protocol === 'https:';
                                if (isHttps) {
                                    throw new types_1.ZebraError('Chrome 로컬 네트워크 접근 권한이 필요합니다. 브라우저 캐시를 삭제하거나 권한을 다시 허용해주세요.', types_1.ZebraErrorCode.PNA_PERMISSION_DENIED, error_6);
                                }
                                else {
                                    throw new types_1.ZebraError('BrowserPrint 서비스에 연결할 수 없습니다. Zebra BrowserPrint가 설치되어 있고 실행 중인지 확인해주세요.', types_1.ZebraErrorCode.BROWSERPRINT_NOT_RUNNING, error_6);
                                }
                            }
