...
var ZebraBrowserPrintWrapper = /** @class */ (function () {
    function ZebraBrowserPrintWrapper() {
        ...
        this.getAvailablePrinters = function () { return __awaiter(_this, void 0, void 0, function () {
            var healthCheck, config, endpoint, res, data, error_2, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.write = function (data, retryWithFreshDevice) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var endpoint, myData, config, res, availablePrinters, freshDevice, i, refreshError_1, error_4, errorMessage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 6, , 7]);
                        ...
                        case 6:
                            error_4 = _a.sent();
                            // PNA 관련 에러 감지
                            if (error_4.name === 'TypeError' && error_4.message.includes('Failed to fetch')) {
                                this.connectionHealthy = false;
                                throw new Error('Chrome 로컬 네트워크 접근 권한이 필요합니다. 브라우저 캐시를 삭제하거나 권한을 다시 허용해주세요.');
                            }
        ...
        this.read = function (retryWithFreshDevice) {
            if (retryWithFreshDevice === void 0) { retryWithFreshDevice = true; }
            return __awaiter(_this, void 0, void 0, function () {
                var endpoint, myData, config, res, availablePrinters, freshDevice, i, refreshError_2, data, error_5, errorMessage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 7, , 8]);
