            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log('[ZebraBrowserPrint] 연결 확인 시작:', endpoint);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        ...
                        if (res.ok) {
                            ...
                            console.log('[ZebraBrowserPrint] ✅ 연결 성공');
                            return [2 /*return*/, {
                                    connected: true,
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('[ZebraBrowserPrint] ❌ 연결 에러:', error_1);
                        this.connectionHealthy = false;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            // 프린트가 아예 연결되지 않은 경우
                            if (!res.ok) {
                                throw new Error("\uD504\uB9B0\uD130 \uC5F0\uACB0\uC744 \uD655\uC778\uD574\uC8FC\uC138\uC694. \uD504\uB9B0\uD130\uAC00 \uC628\uB77C\uC778 \uC0C1\uD0DC\uC774\uACE0 \uC62C\uBC14\uB974\uAC8C \uC5F0\uACB0\uB418\uC5B4 \uC788\uB294\uC9C0 \uD655\uC778\uD558\uC138\uC694. (\uC0C1\uD0DC: " + res.status + " " + res.statusText + ")");
                            }
                            this.connectionHealthy = true;
                            this.lastHealthCheck = Date.now();
                            return [3 /*break*/, 7];
